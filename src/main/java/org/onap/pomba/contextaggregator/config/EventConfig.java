...
public class EventConfig {
    ...
    @Bean
    public EventHeaderConfig eventHeaderConfig(
            @Value("${event.header.domain}") String domain,
            ...
            @Value("${event.header.top-entity-type}") String topEntityType,
            @Value("${event.header.topic-name}") String topicName) {

        return new EventHeaderConfig(domain, sourceName, eventType, entityType, topEntityType, topicName);
    }
}
