...
public class TransportConfig {
    ...
    @Bean
    public String messageRouterRequiredAuditTopicList(@Value("${transport.message-router.requiredAuditTopicList}") String requiredAuditTopicList) {
        return requiredAuditTopicList;
    }
