...
public class EventHeaderConfigTest
{
    ...
    public void getEventTypeTest() {
        Assert.assertEquals(eventHeaderConfig.getDomain(), eventType);
    }

    @Test
    public void getEntityTypeTest() {
        Assert.assertEquals(eventHeaderConfig.getDomain(), entityType);
    }

    @Test
    public void getTopEntityTypeTest() {
        Assert.assertEquals(eventHeaderConfig.getDomain(), topEntityType);
    }

    @Test
    public void getTopicNameTest() {
        Assert.assertEquals(eventHeaderConfig.getDomain(), topicName);
    }
}
